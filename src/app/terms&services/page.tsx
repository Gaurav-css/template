        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-zinc-900 p-8 sm:p-10 rounded-2xl shadow-lg dark:border dark:border-zinc-800">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 dark:text-zinc-300 space-y-6">
            ...
            <Section title="3. Services Provided">
                <p><strong>3.1.</strong> Hooman provides a range of digital pet care tools, including but not limited to reminders for vaccinations and grooming, AI-powered recommendations via Ezra AI, community forums, integration with veterinary partners, pet health tracking, and e-commerce features for pet-related products.</p>
