  ...
  return (
    <div ref={cardRef} style={wrapperStyle}>
      <div
        ...
        className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/50 rounded-lg p-6 flex items-start space-x-6 hover:shadow-lg dark:hover:border-gray-600"
      >
