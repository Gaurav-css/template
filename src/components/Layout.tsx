...
export default function App() {
  ...
  return (
    <div className="bg-white dark:bg-black min-h-screen font-sans text-gray-800 dark:text-gray-200 transition-colors duration-500 flex items-center justify-center overflow-hidden">
